...
class OlevelStudentsExport implements FromCollection, WithHeadings, WithMapping
{
    protected $students;
    ...
    */
    public function collection()
    {
        ...
        return Student::where('level', 'olevel')->get();
    }
    ...
    */
    public function map($student): array
    {
        return [
            ...
            $student->ple_index_number,
            $student->special_issue,
            $student->ple_english,
            $student->ple_mathematics,
            $student->ple_sst,
            $student->ple_science,
            $student->ple_total,
            $student->ple_aggregates,
