    ...
    <x-slot name="header">
        <div class="flex justify-between items-center">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                {{ __('Import Staff Data') }}
            </h2>
            <a href="{{ route('admin.staff.index') }}" class="bg-gray-300 hover:bg-gray-400 text-gray-800 font-bold py-2 px-4 rounded inline-flex items-center">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <div class="mb-6 p-4 bg-blue-50 border-l-4 border-blue-500 text-blue-700">
                        <h3 class="font-bold text-lg mb-2">Instructions for Importing Staff Data</h3>
                        <ul class="list-disc pl-5 space-y-1">
                            <li>Prepare your Excel file with the following columns: surname, first_name, other_name, sex, date_of_birth, etc.</li>
                            ...
                            <li>Required fields: surname, first_name, sex, date_of_birth.</li>
                            ...
                            <li>Sex should be either "Male" or "Female" (or "M" or "F").</li>
                            <li>Maximum file size: 10MB.</li>
                            <li>Supported formats: .xlsx, .xls, .csv</li>
                        </ul>
                        <div class="mt-3">
                            <a href="{{ route('admin.staff.export.excel') }}" class="text-blue-600 hover:text-blue-800 underline">
                                <i class="fas fa-download mr-1"></i> Download sample template
                            </a>
                        </div>
                    </div>

                    <form action="{{ route('admin.staff.import.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                        @csrf
                        
                        <div>
                            <label for="staff_type" class="block text-sm font-medium text-gray-700">Staff Type</label>
                            <select id="staff_type" name="staff_type" class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
