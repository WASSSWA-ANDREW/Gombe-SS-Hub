    ...
    <div class="bg-white dark:bg-gray-800 shadow-lg rounded-lg p-6">
        ...
        <div class="flex justify-between items-center mb-6">
            ...
            <div class="flex space-x-2">
                ...
                <a href="{{ route('admin.students.alevel.edit', $student->admission_number) }}" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded transition duration-150 ease-in-out">
                    Edit
                </a>
                <a href="{{ route('admin.students.alevel.view.pdf', $student->admission_number) }}" class="bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded transition duration-150 ease-in-out" target="_blank">
                    Download PDF
                </a>
            </div>
        </div>
