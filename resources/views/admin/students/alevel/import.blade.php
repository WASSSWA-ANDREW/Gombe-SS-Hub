    ...
    <x-slot name="header">
        <div class="flex justify-between items-center">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                {{ __("Import A'Level Students Data") }}
            </h2>
            <a href="{{ route('admin.students.alevel.index') }}" class="bg-gray-300 hover:bg-gray-400 text-gray-800 font-bold py-2 px-4 rounded inline-flex items-center">
                <i class="fas fa-arrow-left mr-2"></i> {{ __("Back to A'Level Students List") }}
            </a>
        </div>
    </x-slot>
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <div class="mb-6 p-4 bg-blue-50 border-l-4 border-blue-500 text-blue-700">
                        <h3 class="font-bold text-lg mb-2">Instructions for Importing A'Level Students Data</h3>
                        <ul class="list-disc pl-5 space-y-1">
                            ...
                            <li>Date format should be YYYY-MM-DD (e.g., 2003-01-15).</li>
                            <li>Gender should be either "Male" or "Female".</li>
                            <li>Maximum file size: 10MB.</li>
                            <li>Supported formats: .xlsx, .xls, .csv</li>
                        </ul>
                        <div class="mt-3">
                            <a href="{{ route('admin.students.alevel.export.excel') }}" class="text-blue-600 hover:text-blue-800 underline">
                                <i class="fas fa-download mr-1"></i> Download sample template
                            </a>
                        </div>
                    </div>

                    <form action="{{ route('admin.students.alevel.import.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                        @csrf
                        ...
                        <div class="flex items-center justify-end">
                            <button type="submit" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline">
                                <i class="fas fa-upload mr-2"></i> Import A'Level Students Data
                            </button>
                        </div>
                    </form>
                </div>
