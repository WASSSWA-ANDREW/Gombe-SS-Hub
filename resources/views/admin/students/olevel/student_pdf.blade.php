...
<head>
    ...
    <title>O'Level Student Details - {{ $student->student_name }}</title>
    <style>
        body {
...
<body>
    ...
    <!-- PLE Results -->
    <div class="section">
        <div class="section-title">PLE RESULTS</div>
        <div class="info-grid">
            <div class="info-row">
                <div class="info-label">PLE Index Number:</div>
                <div class="info-value">{{ $student->ple_index_number ?? 'N/A' }}</div>
            </div>
        </div>
        <table class="results-table">
            ...
            <tbody>
                <tr>
                    <td>English</td>
                    <td>{{ $student->ple_english ?? 'N/A' }}</td>
                </tr>
                <tr>
                    <td>Mathematics</td>
                    <td>{{ $student->ple_mathematics ?? 'N/A' }}</td>
                </tr>
                <tr>
                    <td>Social Studies</td>
                    <td>{{ $student->ple_sst ?? 'N/A' }}</td>
                </tr>
                <tr>
                    <td>Science</td>
                    <td>{{ $student->ple_science ?? 'N/A' }}</td>
                </tr>
                <tr>
                    <td><strong>Total</strong></td>
                    <td><strong>{{ $student->ple_total ?? 'N/A' }}</strong></td>
                </tr>
                <tr>
                    <td><strong>Aggregates</strong></td>
                    <td><strong>{{ $student->ple_aggregates ?? 'N/A' }}</strong></td>
                </tr>
            </tbody>
        </table>
    </div>
