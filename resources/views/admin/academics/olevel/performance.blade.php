...
@section('title', 'O\'Level Performance')

@section('header', 'O\'Level Student Performance')
...
<div class="space-y-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-gray-800 dark:text-gray-400 text-sm font-medium">Average Grade</p>
                    <p class="text-3xl font-bold text-gray-900 dark:text-white mt-2">A</p>
                </div>
                <div class="bg-green-100 dark:bg-green-900 rounded-full p-3">
                    <i class="fas fa-star text-green-600 dark:text-green-300 text-2xl"></i>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-gray-800 dark:text-gray-400 text-sm font-medium">Pass Rate</p>
                    <p class="text-3xl font-bold text-gray-900 dark:text-white mt-2">95%</p>
                </div>
                <div class="bg-purple-100 dark:bg-purple-900 rounded-full p-3">
                    <i class="fas fa-check-circle text-purple-600 dark:text-purple-300 text-2xl"></i>
                </div>
            </div>
        </div>
            ...
            <table class="w-full text-sm">
                <thead class="bg-gray-100 dark:bg-gray-700">
                    <tr>
                        ...
                        <th class="px-4 py-2 text-center">Rank in Class</th>
                    </tr>
                </thead>
                <tbody>
                    @if($students->count() > 0)
                        @foreach($students->take(10) as $student)
                            <tr class="border-b border-gray-200 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700">
                                ...
                                <td class="px-4 py-3 text-center text-gray-900 dark:text-white">78%</td>
                                <td class="px-4 py-3 text-center">
                                    <span class="bg-green-100 dark:bg-green-900 text-green-800 dark:text-green-200 px-2 py-1 rounded text-xs">A</span>
                                </td>
                                <td class="px-4 py-3 text-center text-gray-900 dark:text-white">5</td>
                            </tr>
                        @endforeach
                    @else
                        <tr>
